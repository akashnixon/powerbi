...
const USERS = {
  ...
  clientC: { username: "clientC", password: "clientC123", role: "clientC" },
};
...
export default function SecurePowerBIPortal() {
  ...
  // Map MSAL account to local user model (simple demo mapping)
  useEffect(() => {
    ...
    // Very simple role mapping: first account -> admin, others -> clientA
    const mappedUser = {
      username: name,
      role: "admin",
    };
